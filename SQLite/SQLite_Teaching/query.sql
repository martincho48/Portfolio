...
--GOALS
-------------------
--1. from two CSV files get a table with where I sum profit for each week number in last few years
--2. the print out data about only active students
...
--drop columns Functions and rowid 
...
--display data about active students
SELECT 	* 
